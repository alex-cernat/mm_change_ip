...
- 8 models failed to converge: all "fiyrdia" models failed to converged and were excluded. The models comparing variances for "lkmove" did not converge so all the models were excluded.
- 21 models had warnings due to convergence. After trying to increase the number of iteration and adding restrictions unsuccessfully we decided to exclude from further analysis the comparison involving: "jpsemp", "smoker", "caruse", "mobuse", etc.
